...
class App:
    def __init__(self) -> None:
        ...
        async def image_search(image: inputImage):
            ...
            csv_path = Path('/Users/Admin/Desktop/DATN/04_SEARCH/class_dict.csv')  # Thay đổi đường dẫn tuyệt đối tới class_dict.csv
            model_path = Path('/Users/Admin/Desktop/DATN/04_SEARCH/Search.h5')  # Thay đổi đường dẫn tuyệt đối tới model
